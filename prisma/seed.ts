...
async function main() {
  ...
  const exercises = [
    ...
    // Rehab existing
    { name: 'Band External Rotation', description: 'Rotator cuff strengthening', muscleGroup: 'Shoulders', imageUrl: '/images/exercises/band-external-rotation.jpg' },
    { name: 'Wall Push-up', description: 'Low-intensity chest and triceps', muscleGroup: 'Chest', imageUrl: '/images/exercises/wall-push-up.jpg' },
    { name: 'Bird Dog', description: 'Core and lower back stability', muscleGroup: 'Core', imageUrl: '/images/exercises/bird-dog.jpg' },
    { name: 'Dead Bug', description: 'Core stability', muscleGroup: 'Core', imageUrl: '/images/exercises/dead-bug.jpg' },
    { name: 'Quad Set', description: 'Quadriceps isometric', muscleGroup: 'Legs', imageUrl: '/images/exercises/quad-set.jpg' },
    { name: 'Straight Leg Raise', description: 'Hip flexor and quad', muscleGroup: 'Legs', imageUrl: '/images/exercises/straight-leg-raise.jpg' },
    { name: 'Mini Squat', description: 'Knee-friendly squat progression', muscleGroup: 'Legs', imageUrl: '/images/exercises/mini-squat.jpg' },
    { name: 'Clam Shell', description: 'Hip external rotation', muscleGroup: 'Hips', imageUrl: '/images/exercises/clam-shell.jpg' },
    { name: 'Hip Bridge', description: 'Glute and hamstring', muscleGroup: 'Legs', imageUrl: '/images/exercises/hip-bridge.jpg' },
    { name: 'Step-down', description: 'Knee control and strength', muscleGroup: 'Legs', imageUrl: '/images/exercises/step-down.jpg' },
    { name: 'Cat-Cow', description: 'Spine mobility', muscleGroup: 'Core', imageUrl: '/images/exercises/cat-cow.jpg' },
    { name: 'Prone Y/T', description: 'Shoulder stabilization', muscleGroup: 'Shoulders', imageUrl: '/images/exercises/prone-yt.jpg' },
    { name: 'Lunge', description: 'Lower body strength', muscleGroup: 'Legs', imageUrl: '/images/exercises/lunge.jpg' },
    // Rehab new
    { name: 'Ankle Alphabet', description: 'Ankle mobility tracing letters with foot', muscleGroup: 'Ankles', imageUrl: '/images/exercises/ankle-alphabet.jpg' },
    { name: 'Towel Curl (Foot)', description: 'Toe curling on towel for foot intrinsic strength', muscleGroup: 'Ankles', imageUrl: '/images/exercises/towel-curl-foot.jpg' },
    { name: 'Calf Raise (Single Leg)', description: 'Single-leg calf raise for strength and balance', muscleGroup: 'Calves', imageUrl: '/images/exercises/calf-raise-single-leg.jpg' },
    { name: 'Eccentric Heel Drop', description: 'Slow lowering of heel off step edge for Achilles rehab', muscleGroup: 'Calves', imageUrl: '/images/exercises/eccentric-heel-drop.jpg' },
    { name: 'Adductor Squeeze', description: 'Isometric adductor strengthening with ball between knees', muscleGroup: 'Hips', imageUrl: '/images/exercises/adductor-squeeze.jpg' },
    { name: 'Side-Lying Hip Adduction', description: 'Bottom leg lift for inner thigh and adductor strength', muscleGroup: 'Hips', imageUrl: '/images/exercises/side-lying-hip-adduction.jpg' },
    { name: 'Hamstring Curl (Prone)', description: 'Prone hamstring curl for isolated hamstring strengthening', muscleGroup: 'Legs', imageUrl: '/images/exercises/hamstring-curl-prone.jpg' },
    { name: 'Nordic Hamstring Curl', description: 'Eccentric hamstring exercise for injury prevention', muscleGroup: 'Legs', imageUrl: '/images/exercises/nordic-hamstring-curl.jpg' },
    { name: 'Foam Roll IT Band', description: 'Self-myofascial release for IT band', muscleGroup: 'Legs', imageUrl: '/images/exercises/foam-roll-it-band.jpg' },
    { name: 'Side-Lying Leg Raise', description: 'Hip abductor strengthening lying on side', muscleGroup: 'Hips', imageUrl: '/images/exercises/side-lying-leg-raise.jpg' },
    { name: 'Terminal Knee Extension', description: 'Band-assisted knee extension for VMO activation', muscleGroup: 'Legs', imageUrl: '/images/exercises/terminal-knee-extension.jpg' },
    { name: 'Eccentric Squat (Decline)', description: 'Slow squat on decline board for patellar tendon rehab', muscleGroup: 'Legs', imageUrl: '/images/exercises/eccentric-squat-decline.jpg' },
    { name: 'Plantar Fascia Roll', description: 'Rolling foot on ball for plantar fascia release', muscleGroup: 'Feet', imageUrl: '/images/exercises/plantar-fascia-roll.jpg' },
    { name: 'Towel Stretch (Calf)', description: 'Seated calf stretch using a towel', muscleGroup: 'Calves', imageUrl: '/images/exercises/towel-stretch-calf.jpg' },
    { name: 'Wrist Extensor Stretch', description: 'Forearm extensor stretch for tennis elbow', muscleGroup: 'Arms', imageUrl: '/images/exercises/wrist-extensor-stretch.jpg' },
    { name: 'Eccentric Wrist Extension', description: 'Slow lowering of wrist extension for lateral epicondylitis', muscleGroup: 'Arms', imageUrl: '/images/exercises/eccentric-wrist-extension.jpg' },
    { name: 'Wrist Flexor Stretch', description: 'Forearm flexor stretch for golfer\'s elbow', muscleGroup: 'Arms', imageUrl: '/images/exercises/wrist-flexor-stretch.jpg' },
    { name: 'Eccentric Wrist Curl', description: 'Slow lowering of wrist curl for medial epicondylitis', muscleGroup: 'Arms', imageUrl: '/images/exercises/eccentric-wrist-curl.jpg' },
    { name: 'Scapular Retraction', description: 'Shoulder blade squeeze for posture and scapular control', muscleGroup: 'Shoulders', imageUrl: '/images/exercises/scapular-retraction.jpg' },
    { name: 'Neck Retraction (Chin Tuck)', description: 'Cervical retraction exercise for neck stability', muscleGroup: 'Neck', imageUrl: '/images/exercises/neck-retraction-chin-tuck.jpg' },
    { name: 'Neck Side Bend Stretch', description: 'Lateral neck stretch for tension relief', muscleGroup: 'Neck', imageUrl: '/images/exercises/neck-side-bend-stretch.jpg' },
    { name: 'Shoulder Pendulum', description: 'Passive shoulder mobility exercise using gravity', muscleGroup: 'Shoulders', imageUrl: '/images/exercises/shoulder-pendulum.jpg' },
    // Powerlifting new
  ...
  for (const exercise of exercises) {
    const created = await prisma.exercise.upsert({
      ...
      update: { imageUrl: exercise.imageUrl ?? null },
      create: exercise,
    })
